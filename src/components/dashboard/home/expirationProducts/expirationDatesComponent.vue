  ...
  <div class="mainContainer">
    ...
    <div style="display: flex; margin-left: 10px; margin-top: 10px">
      ...
      <input
        ...
        placeholder="Ingrese una cantidad de días para ver vencimientos"
        style="
          margin-left: 10px;
          padding: 10px;
          font-size: 15px;
      ...
      />
      <button
        @click="getExpiratedProducts(expirationDays)"
        style="
          margin-left: 10px;
          padding: 10px;
          font-size: 15px;
    ...
    async getExpiratedProducts(days) {
      try {
        ...
        const response = await axios.get(
          `https://api-gestion-ahil.onrender.com/products/toExpirate/${businessId}/${days}`
        );
