  ...
  methods: {
    ...
    async updateInput() {
      try {
        ...
        await axios.put(`https://api-gestion-ahil.onrender.com/inputs/${this.input_Id}`, {
    ...
    async getInputsByName() {
      try {
        const response = await axios.get(
          `https://api-gestion-ahil.onrender.com/inputs/search/${businessId}/${this.inputName}`
        );
        const data = response.data;
    ...
    async getDataOfInput(id) {
      try {
        const response = await axios.get(
          `https://api-gestion-ahil.onrender.com/inputs/search/${id}`
        );
        const data = response.data;
        console.log(data);
        this.changeEditFormStatus();
