  ...
  methods: {
    ...
    async getAllNotes() {
      try {
        const response = await axios.get(
          `https://api-gestion-ahil.onrender.com/notes/${businessId}/notes/ordered-by-due-date`
        );
    ...
    async createNote() {
      try {
        ...
        const note = await axios.post(
          `https://api-gestion-ahil.onrender.com/notes/${businessId}`,
          {
    ...
    async deleteNote(id) {
      try {
        ...
        const deleteNote=await axios.delete(`https://api-gestion-ahil.onrender.com/notes/${id}/${businessId}`)
