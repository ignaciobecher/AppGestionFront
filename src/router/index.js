...
const router = createRouter({
  ...
  routes: [
  ...
  },
    {
      path: "/missingStock",
      component: () =>
        import("../components/dashboard/home/missingProducts/missingElementsComponent.vue"),
    },
    {
      path: "/expirations",
      component: () =>
        import("../components/dashboard/home/expirationProducts/expirationDatesComponent.vue"),
    },
    {
      path: "/salesTest",
